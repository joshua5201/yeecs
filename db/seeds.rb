...
attributes[:category][:main_url] = %w{/posts /pages/feature /member_categories/faculty /pages/course /pages/exchange_program /pages/award /pages/faq /gallery /pages/link}
